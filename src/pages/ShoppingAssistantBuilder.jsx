...
function SkillsTab({ skills, onDelete, onAdd, onEdit, styles }) {
  return (
    <div>
...
function SkillModal({ onClose, onSave, editingSkill = null, styles }) {
  ...
  function handleToolTypeClick(type) {
    if (type === 'MCP') {
      ...
      setAddedTools(prev => [...prev, { type, name: type }])
      setShowToolPicker(false)
    }
  }
  ...
  function removeTool(i) {
    setAddedTools(prev => prev.filter((_, idx) => idx !== i))
  }
              ...
              {showToolPicker ? (
                <div className={styles.toolPicker}>
                  <div className={styles.toolTypeChips}>
                    {TOOL_TYPES.map(t => (
                      <button key={t} className={styles.toolTypeChip} onClick={() => handleToolTypeClick(t)}>
                        {t}
                      </button>
                    ))}
                  </div>
            ...
            <>
              ...
              <div className={styles.formField}>
                ...
                <input
                  ...
                  type="text"
                  value={mcpName}
                  onChange={e => { setMcpName(e.target.value); setSelectedPreset(null) }}
              ...
              <div className={styles.formField}>
                ...
                <input
                  ...
                  type="text"
                  value={mcpDesc}
                  onChange={e => { setMcpDesc(e.target.value); setSelectedPreset(null) }}
              ...
              <div className={styles.formField}>
                ...
                <input
                  ...
                  type="url"
                  value={mcpUrl}
                  onChange={e => { setMcpUrl(e.target.value); setSelectedPreset(null) }}
                  placeholder="https://"
                />
              </div>
